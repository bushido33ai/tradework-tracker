...
const Calendar = () => {
  ...
  return <div className="w-full max-w-6xl mx-auto p-6 space-y-6 rounded-lg shadow-lg border border-slate-200 animate-fade-in bg-slate-500 hover:bg-slate-400">
      ...
      <div className="grid grid-cols-7 gap-px bg-slate-200">
        ...
        return <div key={day.toString()} className={cn("min-h-[120px] bg-slate-50 p-2 text-sm hover:bg-slate-100 transition-colors", !isSameMonth(day, currentDate) && "text-slate-400", "border-t border-slate-200")}>
