  ...
  return (
    <button
      className={cn(
        ...
        // light mode colors - updated to even darker blue/slate
        "bg-[linear-gradient(#020617,#020617),linear-gradient(#020617_50%,rgba(2,6,23,0.9)_80%,rgba(2,6,23,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",

        // dark mode colors - updated to maintain contrast
        "dark:bg-[linear-gradient(#020617,#020617),linear-gradient(#020617_50%,rgba(2,6,23,0.9)_80%,rgba(0,0,0,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",
